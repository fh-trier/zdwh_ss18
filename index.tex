...
\geometry{
  ...
  top=2.7cm,          % Abstand Kopfseite
  bottom=2cm,         % Abstand Fußseite
  left=2.5cm,         % Abstand Linkeseite
...
\newminted{r}{autogobble=true, breaklines=true, linenos=true, keywordcase=upper}
...
\newmintedfile[inputawk]{awkcode}{}
\newmintedfile[inputjson]{jsoncode}{}
\newmintedfile[inputsql]{sqlcode}{}
\newmintedfile[inputr]{rcode}{}
